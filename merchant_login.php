...
if ((!empty($email1)) && (!empty($password1)))
{
    ...
    $conn = new mysqli ($host, $dbusername, $dbpassword, $dbname);
        ...
        else
        {
          ...
          $sql = "SELECT id FROM merchant_account WHERE email = '$email1' and password = '$password1'";
	...
	<div class="limiter">
		...
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				...
				<form class="login100-form validate-form" method="POST" enctype="multipart/form-data" action="merchant_login.php">
					...
					<a href="merchant_signup.php" class="txt2">
							Sign Up
						</a>
					</div>

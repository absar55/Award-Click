  ...
  else
  {
	...
	$run_query = mysqli_query($conn, $query);
  ...
  
      {
		...
		$sql = "UPDATE product_order SET status='Sent' WHERE pid='$variable[0]'";
...
?>
				<tr>
					...
					<button onclick="location.href='../Dashboard/<?php echo $p_image;?>';">View</button>

					</td>
					<td>			
					<button onclick="location.href='change_store.php?var=<?php echo $id;?>';">Change</button>
					</td>

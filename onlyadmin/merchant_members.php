...
$conn = new mysqli ($host, $dbusername, $dbpassword, $dbname);
  ...
  else
  {
	...
	$query = "SELECT * FROM admin_account WHERE email = '$email1'";
...
<body style="  background-color: lightblue;">
	...
	<h2><br></h2>
		...
		<table>
			...
			<tbody>
<?php
      $sql = "SELECT * FROM merchant_account ";
...
?>
				<tr>
					...
					<button onclick="location.href='merchant_detail.php?var=<?php echo $m_email;?>';">More</button>
...
?>	
	...
	<footer>
		<p style="text-align: center; padding-top:10%;">&copy; 2023 Award Cicks Control Panel</p>
	</footer>

...
$rrid = filter_input(INPUT_POST, 'rid');
	...
	if ($_SESSION["role"]==3)
{
	if ((!empty($rrid)))
  
      {
		...
		$sql = "UPDATE marketing_requests SET approve='1'  WHERE rid='$rrid'";
...
<body style="  background-color: lightblue;">
	...
	<main>
	<h2><br></h2>
		<h2>&nbsp;&nbsp;Approve Marketing Requests</h2>
		<table>
			<thead>
				<tr>
					<th>Affliate Email</th>
			...
			<tbody>
<?php
      $sql = "SELECT * FROM marketing_requests where approve='0'" ;
...
?>
				<tr>
					...
					<form method="post" action="active_promotion.php">

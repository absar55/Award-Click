  ...
  $conn = new mysqli ($host, $dbusername, $dbpassword, $dbname);
	...
	else
	{
		...
		if (($change_username!=NULL) && (($change_password!=NULL)))
		{
			...
			$sql = "UPDATE merchant_account SET password='$change_password' WHERE email='$user1'";
			$run_sql = mysqli_query($conn, $sql);

			$sql = "UPDATE merchant_account SET username='$change_username' WHERE email='$user1'";
			$run_sql = mysqli_query($conn, $sql);

			$sql = "UPDATE merchant_account SET phone_number='$change_phone' WHERE email='$user1'";
			$run_sql = mysqli_query($conn, $sql);
...
$query = "SELECT * FROM merchant_account WHERE email = '$user1'";
...
<form action="merchant_detail.php?var=<?php echo $m_email;?>" method="post">

...
$conn = new mysqli ($host, $dbusername, $dbpassword, $dbname);
    ...
    else
    {
      ...
      $run_query = mysqli_query($conn, $query);
        ...
        if ((!empty($title)) && (!empty($wallet)) && (!empty($account_number)) && (!empty($amount))) 
        {
...

            {
              ...
              $sql = "UPDATE accounts SET balance='$balance' WHERE email='$email1'";
              $run_sql = mysqli_query($conn, $sql);



              $sql = "INSERT INTO bank (email, account_title, wallet, account_number, amount)
              values ('$email1','$title', '$wallet', '$account_number', '$amount')";
              $conn->query($sql);
        ...
        <div class="main-sidebar">
          <div class="flex h-full w-full flex-col items-center border-r border-slate-150 bg-white dark:border-navy-700 dark:bg-navy-800">
            ...
            <div class="is-scrollbar-hidden flex grow flex-col space-y-4 overflow-y-auto pt-6">
              <!-- Dashobards -->
              <a href="index.php" class="flex h-11 w-11 items-center justify-center rounded-lg  outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:text-accent-light dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90" x-tooltip.placement.right="&#39;Dashboard&#39;">
              ...
              <!-- Withdrawal -->
              <a href="Withdrawal.php" class="flex h-11 w-11 items-center justify-center rounded-lg bg-primary/10 text-primary outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:bg-navy-600 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25" x-tooltip.placement.right="&#39;Withdrawal &#39;">
            ...
            <div class="card">
              <div class="border-b border-slate-200 p-4 dark:border-navy-500 sm:px-5">
                <div class="flex items-center space-x-2">
                  ...
                  <form method="POST" enctype="multipart/form-data" action="Withdrawal.php">
              ...
              <div class="space-y-4 p-4 sm:p-5">
                <label class="block">
                  ...
                  <input class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" placeholder="Enter Account Title" type="text" name="title" required autocomplete="title" class="form-control">
                </label>
                ...
                <select
                  ...
                  <div class="grid grid-cols-2 gap-4">
                    ...
                    <label class="block">
                      <span>Amount</span>
                      <input class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" placeholder="Amount" type="number" min="1" name="amount" required autocomplete="amount">
                    </label>
                  </div>
                </div>
...
<!--
 ...
 <?php  
              ...
              $sql = "SELECT * FROM bank where email='$email1'";
                    ...
                    <div class="flex items-center justify-between">
                      <div class="flex space-x-4">
                        ...
                        <p class="mt-0.5 text-xs line-clamp-1">
                          ...
                          <p class="mt-0.5 text-xs line-clamp-1">
                          Account Title: <?php echo $account_title ?>
                          </p>
                      ...
                      <a style="text-align: center;" class="btn min-w-[7rem] bg-primary font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90"><?php echo $row["status"] ?></a>

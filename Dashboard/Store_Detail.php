...
$conn = new mysqli ($host, $dbusername, $dbpassword, $dbname);
    ...
    else
    {
      ...
      $run_query = mysqli_query($conn, $query);
        ...
        $name_hash = aes($name, $mode1);

       
      
        $email_hash = aes($email1, $mode1);
...
.contract-trigger:before {
  ...
  <body x-data="" class="is-header-blur" x-bind="$store.global.documentBody">
        ...
        <div class="main-sidebar">
          <div class="flex h-full w-full flex-col items-center border-r border-slate-150 bg-white dark:border-navy-700 dark:bg-navy-800">
            ...
            <div class="flex flex-col items-center space-y-3 py-3">
              <!-- Settings -->
              <!-- Store -->
              <a href="Stores.php" class="flex h-11 w-11 items-center justify-center rounded-lg bg-primary/10 text-primary outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:bg-navy-600 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25" x-tooltip.placement.right="&#39;Stores &#39;">
      ...
      <div class="flex items-center space-x-4 py-5 lg:py-6">
          ...
          <ul class="hidden flex-wrap items-center space-x-2 sm:flex">
            <li class="flex items-center space-x-2">
              <a class="text-primary transition-colors hover:text-primary-focus dark:text-accent-light dark:hover:text-accent" href="https://lineone.piniastudio.com/form-layout-3.html#">Forms</a>
        ...
        <div class="grid place-items-center">
          <div class="card mt-20 w-full sm:p-5" x-data="pages.initCreditCard">
            ...
            <div class="space-y-4">
              <label class="block">
                <span class="text-xl font-semibold text-primary dark:text-accent-light">Grocery Store</span>
              </label>
              ...
              <label class="block">
                <span>http://localhost/Grocery%20Store/cust-index.php?ref=<?php echo $email_hash?></span>
              </label>
              ...
              <div class="flex justify-center space-x-2 pt-4">
                ...
                <button onclick="copyToClipboard()" class="btn min-w-[7rem] bg-primary font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">
                  Copy To Clipboard
                </button>
              ...
              $dbname2 = "grocery";
              // Create connection
              $conn2 = new mysqli ($host2, $dbusername2, $dbpassword2, $dbname2);
    if (mysqli_connect_error())
    {
      die('Connect Error ('. mysqli_connect_errno() .') '
     . mysqli_connect_error());
    ...
    else
    {
        ...
        $query1 = "SELECT SUM(total_bill) AS total_sum FROM sales where affliate_email='$email1'";
        $result1 = $conn2->query($query1);

        if ($result1) {
            $row1 = $result1->fetch_assoc();
            $sum_pkr = $row1['total_sum'];

         }


         $query1 = "SELECT SUM(no_of_products) AS total_products FROM sales where affliate_email='$email1'";
         $result1 = $conn2->query($query1);
 
         if ($result1) {
             $row1 = $result1->fetch_assoc();
             $sum_products = $row1['total_products'];
          ...
          $query1 = "SELECT COUNT(*) AS row_count FROM sales WHERE affliate_email = '$email1'";
          $result1 = $conn2->query($query1);
    ...
    ?>
              ...
              <p style=color:white font-size:300%;><br><br>Total Number of Sales: <?php echo $count ?></p>
              <p style=color:white><br>No. of Units Sold: <?php echo $sum_products ?></p>
              <p style=color:white><br>Sales in PKR: <?php echo $sum_pkr ?></p>
...
function copyToClipboard() {
  ...
  dummy.value = "http://localhost/Grocery%20Store/cust-index.php?ref=<?php echo $email_hash?>";
  dummy.select();

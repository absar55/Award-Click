...
$new_affliate_email = filter_input(INPUT_POST, 'affliate_email');
$new_merchant_email = filter_input(INPUT_POST, 'merchant_email');
$new_website = filter_input(INPUT_POST, 'website');
$new_commission = filter_input(INPUT_POST, 'commission');
...
$conn = new mysqli ($host, $dbusername, $dbpassword, $dbname);
    ...
    else
    {
      ...
      $run_query = mysqli_query($conn, $query);
        ...
        if ((!empty($new_affliate_email)) && (!empty($new_merchant_email)) && (!empty($new_website)) && (!empty($new_commission)))

        {
         

          $sql = "SELECT * FROM marketing_requests where affliate_email='$new_affliate_email' AND merchant_email='$new_merchant_email'";
          ...
          else
          {
            ...
            $sql = "INSERT INTO marketing_requests (affliate_email, merchant_email, website, commission)
            values ('$new_affliate_email','$new_merchant_email', '$new_website', '$new_commission')";
            $conn->query($sql);
...
.contract-trigger:before {
        ...
        <div class="main-sidebar">
          <div class="flex h-full w-full flex-col items-center border-r border-slate-150 bg-white dark:border-navy-700 dark:bg-navy-800">
            ...
            <div class="flex flex-col items-center space-y-3 py-3">
              ...
              <a href="Stores.php" class="flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25" x-tooltip.placement.right="&#39;Stores &#39;">
 ...
 ?>
                   <button
                     id="rightTopButton"
                     class="btn bg-red-500 font-medium text-white hover:bg-red-600 focus:bg-red-600 active:bg-red-600/80 dark:bg-red-700 dark:text-white dark:hover:bg-red-800 dark:focus:bg-red-800 dark:active:bg-red-800/90"
                     @click="$notification({text:'Already Applied',variant:'info',position:'right-top'})"
                   >
                     Right Top
                   </button>
                   </div>
 ...
 ?>
                   <button
                     id="rightTopButton"
                     class="btn bg-red-500 font-medium text-white hover:bg-red-600 focus:bg-red-600 active:bg-red-600/80 dark:bg-red-700 dark:text-white dark:hover:bg-red-800 dark:focus:bg-red-800 dark:active:bg-red-800/90"
                     @click="$notification({text:'Approval Request Has been Submitted',variant:'info',position:'right-top'})"
                   >
                     Right Top
                   </button>
                   </div>
                ...
                <div class="card justify-center p-4.5">
                  <div class="flex items-center justify-between">
                    <div>
                      ...
                      <p class="text-xs+ line-clamp-1">Total Turnover</p>
                    </div>
                ...
                <div class="card justify-center p-4.5">
                  <div class="flex items-center justify-between">
                    <div>
                      ...
                      <p class="text-xs+ line-clamp-1">Total Sales Count</p>
                    </div>
                ...
                <div class="card justify-center p-4.5">
                  <div class="flex items-center justify-between">
                    <div>
                      ...
                      <p class="text-xs+ line-clamp-1">Total Earned</p>
                    </div>
                ...
                <div class="card justify-center p-4.5">
                  <div class="flex items-center justify-between">
                    <div>
                      ...
                      <p class="text-xs+ line-clamp-1">Approved Stores</p>
                    </div>
 ...
 <?php  
              ...
              $sql = "SELECT * FROM merchant_account where paid='1'";
              $results = mysqli_query($conn, $sql);
                    ...
                    <div class="flex items-center justify-between">
                      <div class="flex space-x-4">
                        ...
                        <p class="mt-0.5 text-xs line-clamp-1">
                          ...
                          <p class="mt-0.5 text-xs line-clamp-1">
                          Current Marketers: <?php echo $no_of_marketers ?>
                          </p>
                      ...
                      <input type="hidden" name="affliate_email" value="<?php echo $email1;?>">
                      <input type="hidden" name="merchant_email" value="<?php echo $merchant;?>">

...
if (isset($new_password))
{
  ...
  $sql = "UPDATE accounts SET password='$new_password' where email='$email1'";
...
else if (isset($new_phone))
{



  $sql = "UPDATE accounts SET phone_number='$new_phone' where email='$email1'";
  $run_sql = mysqli_query($conn, $sql);
  $word="Phone Number";
  $key=1;
        ...
        <div class="main-sidebar">
          <div class="flex h-full w-full flex-col items-center border-r border-slate-150 bg-white dark:border-navy-700 dark:bg-navy-800">
            ...
            <div class="is-scrollbar-hidden flex grow flex-col space-y-4 overflow-y-auto pt-6">
              <!-- Dashobards -->
              <a href="index.php" class="flex h-11 w-11 items-center justify-center rounded-lg  transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25  dark:text-accent-light dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90" x-tooltip.placement.right="&#39;Dashboard&#39;">
              ...
              <!-- Setting -->
              <a href="setting.php" class="flex h-11 w-11 items-center justify-center rounded-lg bg-primary/10 text-primary outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:bg-navy-600 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
            ...
            <div class="flex flex-col items-center space-y-3 py-3">
              <!-- Store -->
              <a href="Stores.php" class="flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25" x-tooltip.placement.right="&#39;Withdrawal &#39;">
              <img src = "../svg/shop.png" alt="" width="22px" height="22px"/>
              </a>
...
?>
                  <button
                    ...
                    @click="$notification({text:'<?php echo $word?> Has Been Changed Successfully',variant:'info',position:'right-top'})"
                  >
                    Right Top
                  </button>
                  </div>
      ...
      <div class="flex items-center space-x-4 py-5 lg:py-6">
          ...
          <ul class="hidden flex-wrap items-center space-x-2 sm:flex">
            <li class="flex items-center space-x-2">
              <a class="text-primary transition-colors hover:text-primary-focus dark:text-accent-light dark:hover:text-accent" href="https://lineone.piniastudio.com/form-layout-3.html#"></a>
          ...
          <div class="card mt-20 w-full max-w-xl p-4 sm:p-5" x-data="pages.initCreditCard">
            <div class="relative mx-auto -mt-20 h-40 w-72 rounded-lg text-white shadow-xl transition-transform hover:scale-110 lg:h-48 lg:w-80">
              ...
              <div class="absolute top-0 flex h-full w-full flex-col justify-between p-4 sm:p-5">
                <div class="flex justify-between">
                  <div>
                    <p class="text-xs+ font-light">Name:&nbsp;&nbsp;&nbsp;<?php echo $name ?></p>
                    <p class="text-xs+ font-light">Email:&nbsp;&nbsp;&nbsp;<?php echo $email1 ?></p>

                    <p class="font-medium uppercase tracking-wide" x-text="nameOnCard"></p>
                  </div>
                  <template x-if="cardLogoSrc"></template>
                </div>
                <div class="pt-4">
                <p class="text-xs+ font-light">Phone Number:&nbsp;&nbsp;&nbsp;<?php echo $phone ?></p>
                  <p class="font-medium tracking-wide" x-text="cardNumber"></p>
                </div>
              </div>
            </div>
            <div class="flex items-center justify-between py-4">
              <p class="text-xl font-semibold text-primary dark:text-accent-light">Your Profile</p>
            ...
            <form method="POST" enctype="multipart/form-data" action="Setting.php">
            <div style="padding-top: 20px;">
            <div class="space-y-4">
              <label class="block">
                <span>Change Password</span>
                <input class="form-input mt-1.5 w-full rounded-lg bg-slate-150 px-3 py-2 ring-primary/50 placeholder:text-slate-400 hover:bg-slate-200 focus:ring dark:bg-navy-900/90 dark:ring-accent/50 dark:placeholder:text-navy-300 dark:hover:bg-navy-900 dark:focus:bg-navy-900" placeholder="Enter New Password" type="password" pattern="[A-Za-z0-9@!_.]{8,30}" title="Don't use Space & Special Characters excpet ( @ ! _ .) & Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters"  name="password" required autocomplete="password">
              </label>
            ...
            <div class="space-y-4">
              <label class="block">
                ...
                <input class="form-input mt-1.5 w-full rounded-lg bg-slate-150 px-3 py-2 ring-primary/50 placeholder:text-slate-400 hover:bg-slate-200 focus:ring dark:bg-navy-900/90 dark:ring-accent/50 dark:placeholder:text-navy-300 dark:hover:bg-navy-900 dark:focus:bg-navy-900" placeholder="Enter New Phone Number" type="tel" pattern="+[0-9]{12}" title="Like 03012345678"  name="phone" required autocomplete="phone">
              </label>
...
function copyToClipboard() {
  ...
  dummy.value = "http://localhost/Award%20Click/signup.php?refer=<?php echo $email1?>,<?php echo $amount_hash?>";
  dummy.select();

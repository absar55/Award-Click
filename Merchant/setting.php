...
if (isset($new_password))
{
  ...
  $sql = "UPDATE merchant_account SET password='$new_password' where email='$email1'";
...
else if (isset($new_phone))
{
  ...
  $sql = "UPDATE merchant_account SET phone_number='$new_phone' where email='$email1'";
  $run_sql = mysqli_query($conn, $sql);
  $word="Phone Number";
  $key=1;

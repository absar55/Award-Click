...
$variable = explode(",", $_GET["refer"]);

require __DIR__ . '/Dashboard/encryption.php';
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form" method="POST" enctype="multipart/form-data" action="connector.php">
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate="Phone Number is required">
						<span class="label-input100">Sponsor Email</span>
						<input class="input100" type="text" value="<?php echo $variable[0] ?>" name="sponsor_email" readonly>
						<span class="focus-input100" data-symbol="&#xf206;"></span>

					</div>

					<div class="wrap-input100 validate-input m-b-23" data-validate="Phone Number is required">
						<span class="label-input100">Deposit Amount</span>
						<input class="input100" type="number" value="<?php echo $amount ?>" name="amount" readonly>
						<span class="focus-input100" data-symbol="&#xf206;"></span>
